...
// npm install echarts react-echarts postgres
...
//   const colorPalette = ['#80FFA5', '#00DDFF', '#37A2FF', '#FF0087', '#FFBF00'];
...
//       },
//     ],
//     series: ageRanges.map((ageRange, index) => ({
//       name: ageRange,
//       type: 'line',
//       stack: 'Total',
//       smooth: true,
...
//           {
//             offset: 0,
//             color: colorPalette[index % colorPalette.length], // Use different color for each line
//           },
//           {
//             offset: 1,
